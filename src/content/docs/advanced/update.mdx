---
title: 'Update Theme'
description: 'Update ݙیپال | Ali to the latest version'
order: 1
---
...
- Changed Github Card component to `GithubCard` in `src/components/advanced`. See [Advanced Components #Github Card](/docs/integrations/advanced#github-card) for usage.
...
name: ݙیپال | Ali
desc: Diff for Blog v.s. ݙیپال | Ali
